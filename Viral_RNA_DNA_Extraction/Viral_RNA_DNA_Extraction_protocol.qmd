...
df |> 
  ...
  add_row(Step_number="6",Description="Disinfect the BSC. Spray a paper towel with quatricide and wipe all reagents, pipettes, tip boxes and equipment before placing inside BSC. Spray pipettes with RNAZap as well. See table on next page for list of reagents:",Performer_Initials="",Reviewer_Initials="") |> 
  kable() |> 
...
tibble(`Item in BSC`=character(),check1=character(),`Item in Mini Fridge`=character(),check2=character()) |> 
  ...
  add_row(`Item in BSC`='1000uL filter tips',check1='',`Item in Mini Fridge`='',check2='') |> 
  add_row(`Item in BSC`="1 x pipette aid",check1="",`Item in Mini Fridge`="",check2="") |> 
  add_row(`Item in BSC`='1 x Well Plate Tray',check1='',`Item in Mini Fridge`='',check2='') |> 
  add_row(`Item in BSC`='1 x 8-tube PCR strip',check1='',`Item in Mini Fridge`='',check2='') |> 
  add_row(`Item in BSC`='1 x Sharpie',check1='',`Item in Mini Fridge`='',check2='') |> 
  kable() |> 
  kableExtra::column_spec(1:4,border_left = T, border_right = T) |> 
  kableExtra::kable_styling()
